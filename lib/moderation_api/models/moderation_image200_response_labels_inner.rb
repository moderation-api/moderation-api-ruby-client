...
module ModerationApi
  class ModerationImage200ResponseLabelsInner
    ...
    def valid?
      ...
      label_validator = EnumAttributeValidator.new('String', ["nudity", "suggestive", "gore", "hate", "violence", "weapon", "smoking", "drugs", "alcohol", "text", "unknown_default_open_api"])
    ...
    def label=(label)
      validator = EnumAttributeValidator.new('String', ["nudity", "suggestive", "gore", "hate", "violence", "weapon", "smoking", "drugs", "alcohol", "text", "unknown_default_open_api"])
