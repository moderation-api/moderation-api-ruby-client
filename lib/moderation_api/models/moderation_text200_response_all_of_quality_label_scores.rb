...
module ModerationAPI
  ...
  class ModerationText200ResponseAllOfQualityLabelScores
    ...
    attr_accessor :unsubstantial

    # Difficult to understand, nonsensical.
    attr_accessor :incoherent
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'unsubstantial')
        self.unsubstantial = attributes[:'unsubstantial']
      end

      if attributes.key?(:'incoherent')
        self.incoherent = attributes[:'incoherent']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          unsubstantial == o.unsubstantial &&
          incoherent == o.incoherent &&
          spam == o.spam &&
          neutral == o.neutral
    end
    ...
    def hash
      [unsubstantial, incoherent, spam, neutral].hash
    end
