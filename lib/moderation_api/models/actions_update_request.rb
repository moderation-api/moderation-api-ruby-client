...
module ModerationAPI
  class ActionsUpdateRequest
    ...
    def self.openapi_types
      {
        ...
        :'free_text' => :'Boolean',
        :'webhooks' => :'Array<ActionsCreateRequestWebhooksInner>'
      }
    end
    ...
    def hash
      [key, name, description, queue_behaviour, filter_in_queue_ids, position, possible_values, value_required, free_text, webhooks].hash
    end
