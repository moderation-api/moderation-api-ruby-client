...
module ModerationAPI
  ...
  class ModerationText200ResponseAllOfRequest
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'quota_usage')
        self.quota_usage = attributes[:'quota_usage']
      else
        self.quota_usage = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @quota_usage.nil?
        invalid_properties.push('invalid value for "quota_usage", quota_usage cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @quota_usage.nil?
      true
    end
