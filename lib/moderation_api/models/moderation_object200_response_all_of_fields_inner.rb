...
module ModerationAPI
  class ModerationObject200ResponseAllOfFieldsInner
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'flagged_by')
        if (value = attributes[:'flagged_by']).is_a?(Array)
    ...
    def list_invalid_properties
      ...
      if @flagged_by.nil?
        invalid_properties.push('invalid value for "flagged_by", flagged_by cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @flagged_by.nil?
      true
    end
