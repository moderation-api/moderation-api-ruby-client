...
module ModerationApi
  ...
  class ModerationText200ResponseAllOfToxicityLabelScores
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'discrimination')
        self.discrimination = attributes[:'discrimination']
      end

      if attributes.key?(:'severe_toxicity')
        self.severe_toxicity = attributes[:'severe_toxicity']
      end

      if attributes.key?(:'insult')
        self.insult = attributes[:'insult']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          severe_toxicity == o.severe_toxicity &&
          insult == o.insult &&
          threat == o.threat &&
          neutral == o.neutral
    end
    ...
    def hash
      [toxicity, profanity, discrimination, severe_toxicity, insult, threat, neutral].hash
    end
