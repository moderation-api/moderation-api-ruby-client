...
module ModerationApi
  ...
  class ModerationText200ResponseAllOfToxicity
    ...
    def self.openapi_types
      {
        :'label_scores' => :'ModerationText200ResponseAllOfToxicityLabelScores',
        :'label' => :'String',
        :'score' => :'Float',
        :'error' => :'String',
        :'warning' => :'String'
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'label_scores')
        self.label_scores = attributes[:'label_scores']
      else
        self.label_scores = nil
      end
    ...
    def list_invalid_properties
      ...
      if @label_scores.nil?
        invalid_properties.push('invalid value for "label_scores", label_scores cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @label_scores.nil?
      true
    end
    ...
    def hash
      [label_scores, label, score, error, warning].hash
    end
