...
module ModerationAPI
  ...
  class ModerationObjectRequestValue
    ...
    def self.openapi_types
      {
        :'type' => :'String',
        :'data' => :'Hash<String, ModerationObjectRequestValueDataValue>'
      }
    end
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ["profile", "event", "product", "object", "unknown_default_open_api"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["profile", "event", "product", "object", "unknown_default_open_api"])
