...
module ModerationApi
  ...
  class ModerationText200ResponseAllOfProprietyLabelScores
    ...
    attr_accessor :flirtation

    # References to sexual acts, body parts, etc.
    attr_accessor :sexually_explicit
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'flirtation')
        self.flirtation = attributes[:'flirtation']
      end

      if attributes.key?(:'sexually_explicit')
        self.sexually_explicit = attributes[:'sexually_explicit']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          flirtation == o.flirtation &&
          sexually_explicit == o.sexually_explicit &&
          neutral == o.neutral
    end
    ...
    def hash
      [flirtation, sexually_explicit, neutral].hash
    end
